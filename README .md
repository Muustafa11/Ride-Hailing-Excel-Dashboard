...
In this project, I aim to analyze ride-hailing booking data using Excel to help operations and business teams understand why rides fail to complete, where demand is concentrated, and how revenue and cancellations behave throughout the day. The dashboard is built entirely in Excel on a single sheet, using a Freeze Pane layout, KPI cards, and Pivot Charts.
...
Total Revenue, No Driver Found rate, Cancellation Rate, Non-completion rate, and Completion Rate
<br>
